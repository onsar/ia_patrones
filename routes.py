...
from services import guardar_registro, generar_reading_register_service, ejecutar_consulta_datadis_service, reducir_perfiles_diarios_pca_service, reconstruir_perfiles_pca_service
...
@router.post("/perfiles/pca_365x7/reconstruir", summary="Reconstruir perfiles originales desde salida PCA (alias compatible)")
